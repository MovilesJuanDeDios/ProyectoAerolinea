...
import cr.ac.una.escinf.proyectoaerolinea.connection.UserConnection;
...
public class RegisterActivity extends BaseActivity
        ...
        new android.os.Handler().postDelayed(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        UserRegisterConnection con = new UserRegisterConnection();
    ...
    private boolean validate() {
        ...
        if (username.isEmpty()) {
            ...
            if (getUser() != null) {
                username_input.setError(getString(R.string.existing_username));
                username_input.requestFocus();
                valid = false;
            } else {*/
    ...
    public Usuario getUser(String...params) {
        ...
        try {
            ...
            if (items != null) {
                for (int i = 0; i < items.length(); i++) {
                    ...
                    Usuario usu = new Usuario(nombre, apellidos, correo, fechaNacimiento, direccion,
    ...
    public class UserRegisterConnection extends AsyncTask<String, String, Boolean> {
